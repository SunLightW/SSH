...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${ctx}/static/admin/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${ctx}/static/admin/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="${ctx}/static/admin/css/animate.css" rel="stylesheet">
    <link href="${ctx}/static/admin/css/style.css?v=4.1.0" rel="stylesheet">
</head>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctx}/static/admin/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctx}/static/admin/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
...
<script src="${ctx}/static/admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="${ctx}/static/admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="${ctx}/static/admin/js/plugins/layer/layer.min.js"></script>

<!-- 自定义js -->
<script src="${ctx}/static/admin/js/hAdmin.js?v=4.1.0"></script>
<script type="text/javascript" src="${ctx}/static/admin/js/index.js"></script>

<!-- 第三方插件 -->
<script src="${ctx}/static/admin/js/plugins/pace/pace.min.js"></script>
